...
uint8_t StTextSize=0; // size of Characters
...
void ST7735_OutClearChar(char ch){
  if((ch == 10) || (ch == 13) || (ch == 27)){
    ...
    ST7735_DrawClearString(0,StY,"                     ",StTextColor);
    return;
  }
  ST7735_DrawClearCharS(StX*6,StY*10,ch,StTextColor, 1);
  StX++;
  if(StX>20){
    StX = 20;
    ST7735_DrawClearCharS(StX*6,StY*10,'*',StTextColor, 1);
  }
  return;
}
